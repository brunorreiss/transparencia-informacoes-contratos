...
logger_name = env.get('BOT_NAME', default='https://portaltransparencia-back.sepog.fortaleza.ce.gov.br/api/contratos')
...
tags_metadata = [
    {
        'name': 'transparencia-informacoes-contratos',
        'description': 'Consulta Portal Tranparencia Fortaleza - informacoes contratos'
    }
]
...
#---------------------------- Application -------------------------------
app = FastAPI(
    title='REST API - Consulta Portal Tranparencia Fortaleza - Informações de contratos', 
    description=desc, 
    debug=False, 
